...
public class AdicionalesVuelta extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AdicionalesVuelta frame = new AdicionalesVuelta();
	...
	public AdicionalesVuelta() {
		...
		Linea.setBounds(512, 100, 40, 532);
		...
		lblSeleccionaTuAsiento.setBounds(45, 127, 198, 26);
		...
		JLabel lblSeleccinDeAdicionales_1 = new JLabel("Selecci\u00F3n de Adicionales -Vuelta");
		lblSeleccinDeAdicionales_1.setForeground(new Color(0, 0, 128));
		lblSeleccinDeAdicionales_1.setFont(new Font("Trebuchet MS", Font.BOLD, 24));
		lblSeleccinDeAdicionales_1.setBounds(342, 72, 383, 43);
		contentPane.add(lblSeleccinDeAdicionales_1);
